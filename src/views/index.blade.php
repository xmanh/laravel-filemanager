...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{ asset('lfm/img/72px color.png') }}">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/css/bootstrap.min.css">
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.5.0/css/all.css">
  <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.css">
  <link rel="stylesheet" href="{{ asset('lfm/css/cropper.min.css') }}">
  <link rel="stylesheet" href="{{ asset('lfm/css/dropzone.min.css') }}">
  <link rel="stylesheet" href="{{ asset('lfm/css/mime-icons.min.css') }}">
  {{-- <style>{!! \File::get(base_path('vendor/unisharp/laravel-filemanager/public/css/lfm.css')) !!}</style> --}}
  {{-- Use the line below instead of the above if you need to cache the css. --}}
  <link rel="stylesheet" href="{{ asset('/lfm/css/lfm.css') }}">
</head>
<body>
  ...
  <script src="{{ asset('lfm/js/cropper.min.js') }}"></script>
  <script src="{{ asset('lfm/js/dropzone.min.js') }}"></script>
  <script>
  ...
  <script src="{{ asset('lfm/js/script.js') }}"></script>
  <script>
    Dropzone.options.uploadForm = {
      ...
      acceptedFiles: "{{ implode(',', array_keys($helper->availableMimeTypes())) }}",
